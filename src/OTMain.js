...
import { delay, jumpLine, print } from './utils/prompt.js'

export async function startOTMetrics(projectPath, useManualExercising = false) {
    ...
    const serverUrl = await startCollecting(projectPath, useManualExercising)    
    const startDate = Date.now()

    await startExercising(projectPath, serverUrl, useManualExercising)
